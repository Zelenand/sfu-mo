...
minimum = coordinat_descent(f_0, d_f_0_1, d_f_0_2, x0, eps1, eps2, M)
print("X0:", x0)
...
def plots(parameters, p):
    ...
    for i in parameters:
        print(i)
        if p == "X0":
            min = coordinat_descent(f_0, d_f_0_1, d_f_0_2, i, eps1, eps2, M,)
        elif p == "epsilon1":
            min = coordinat_descent(f_0, d_f_0_1, d_f_0_2, x0, i, eps2, M)
        elif p == "epsilon2":
            min = coordinat_descent(f_0, d_f_0_1, d_f_0_2, x0, eps1, i, M)
        elif p == "M":
            min = coordinat_descent(f_0, d_f_0_1, d_f_0_2, x0, eps1, eps2, i)
