...
def newton_rafson(f, df1, df2, x0, eps1, eps2, M):
    global cache_0
    global cache_1
    global cache_2
...
minimum = newton_rafson(func, func_d1 ,func_d2, x0, eps1, eps2, M)
print("X0:", x0)
...
def plots(parameters, p):
    ...
    for i in parameters:
        print(i)
        if p == "X0":
            min = newton_rafson(func, func_d1 ,func_d2, i, eps1, eps2, M,)
        elif p == "epsilon1":
            min = newton_rafson(func, func_d1 ,func_d2, x0, i, eps2, M)
        elif p == "epsilon2":
            min = newton_rafson(func, func_d1 ,func_d2, x0, eps1, i, M)
        elif p == "M":
            min = newton_rafson(func, func_d1 ,func_d2, x0, eps1, eps2, i)
